CLASS znov05_cl_generate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS znov05_cl_generate_travel_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF ztnov05_travel.
...
*   delete existing entries in the database table
    DELETE FROM ztnov05_travel.

*   insert the new table entries
    INSERT ztnov05_travel FROM TABLE @itab.
